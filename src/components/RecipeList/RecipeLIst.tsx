...
import { fetchRecepies, addRecepieToFavorites } from './RecepieListSlice';
import { cloneRecepies } from '../Filters/FiltersSlice';

import type { Recepie } from '../../types/type';
import nextId from "react-id-generator";

const RecipeLIst = ({url}:{url:string}) => {
    ...
    const handleAddFavorite = (id: string|number|null, userIdAuth: string) => {
        dispatch(addRecepieToFavorites(id, ));
    };
            ...
            const renderedList = items.map(item => {
                ...
                return(
                    <li key={id} className="recipe-list__item">
                        ...
                        <button 
                            className="recipe-list__favorite-btn"
