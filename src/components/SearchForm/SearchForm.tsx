...
const SearchForm = () => {
    const [inputByName, setInputByName] = useState<string>('');
    ...
    const handleKeyDown = (event: React.KeyboardEvent<HTMLInputElement>) => {
        if (event.code === 'Enter') {
            dispatch(filterRecepiesByName({...recepies, value: inputByName}));
        }
    }
            ...
            <div className="searchForm__input-wrapper">
                <input className="searchForm__searchByName" 
                    ...
                    <button className="searchForm__searchBtn"
                        onClick={() => handleSearchClick(inputByName, recepies)}>
