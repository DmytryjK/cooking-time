...
const AuthRegister = (props: Props) => {
  ...
  return (
    <div className={`authentication__block register ${isOpen ? "active" : ""}`}>
      <h1 className="authentication__block-title">Зареєструватись</h1>
      <div className="authentication__block-list">
        <form className="authorization__window-form form-email" onSubmit={handleCreateUser} ref={registerForm}>
          ...
          <LoadingDataBtn
            ...
            handleSubmit={() => registerForm.current?.requestSubmit()}
          />
        </form>
      </div>
