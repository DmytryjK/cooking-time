...
const EditRecipeForm: FC<{
    ...
    const [statusUploadedPhoto, setStatusUploadedPhoto] = useState<
        '' | 'error' | 'success' | 'pending'
    >('');
    const [imageRefFromStorage, setImageRefFromStorage] = useState<string>('');
    const [tagsValue, setTagsValue] = useState<IngredientsType[] | undefined>(
        ingredients
    );
        ...
        <>
            ...
            <form className="edit-recipe__form" action="">
                ...
                <label className="form__upload-label">
                    <span>Фото</span>
                    <input className="form__upload-photo" type="file" />
                    <span
