...
const AddRecipePage = () => {
    ...
    const isMessageClosed =
        sessionStorage.getItem('isMessageClosed') === 'true';
    const { uid } = useAppSelector((state) => state.authentication.user);
    const [isUnauthorizedAttention, setIsUnauthorizedAttention] = useState(
        !uid && !isMessageClosed
    );
                            ...
                            {isUnauthorizedAttention && (
                                ...
                                >
                                    <div className="add-recepie__unauthorized-inner">
                                        <p>
                                            Зверніть увагу, що ви додаєте
                                            рецепт, як не авторизований
                                            користувач. Ваш рецепт зможуть
