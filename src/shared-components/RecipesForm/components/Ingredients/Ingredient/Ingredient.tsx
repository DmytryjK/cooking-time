...
import { Reorder, LazyMotion, domAnimation, useDragControls, easeOut } from "framer-motion";
...
const Ingredient = ({
  ...
  const isCurrentItemDragged = isIngredientDragEnd && !isIngredientDragEnd.isDragEnd && isIngredientDragEnd.id === id;
  const movedItems = isIngredientDragEnd && !isIngredientDragEnd.isDragEnd && isIngredientDragEnd.id !== id;
  ...
  return (
    <LazyMotion features={domAnimation}>
      <Reorder.Item
        ...
        className={`tagsForm__createdTag createdTag ${isCurrentItemDragged ? "dragged" : ""} ${
          movedItems ? "moved" : ""
        }`}
      >
        <button className="createdTag__move-ingredient" type="button" onPointerDown={(e) => controls.start(e)}>
          ⋮⋮
        </button>
        <div className="createdTag__left-wrapper">
          ...
          />
          <div className="createdTag__label-wrapper">
